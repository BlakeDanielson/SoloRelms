"""initial_schema_with_correct_enums

Revision ID: 239aacb68e83
Revises: 
Create Date: 2025-05-23 13:17:26.788966
...
def upgrade() -> None:
    ...
    sa.Column('total_adventures', sa.Integer(), nullable=True),
    ...
    op.create_index(op.f('ix_story_arcs_user_id'), 'story_arcs', ['user_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_story_arcs_user_id'), table_name='story_arcs')
